...
cc -g -O2 -DMSIZE=64 ../src/matrix_multiply.c -o ../bin/matrix_multiply.out
...
cc -g -O2 -DMSIZE=64 ../src/matrix_multiply_opt.c -o ../bin/matrix_multiply_opt.out
...
cc -g -O2 -DMSIZE=1000 ../src/matrix_multiply.c -o ../bin/matrix_multiply.out
...
cc -g -O2 -DMSIZE=1000 ../src/matrix_multiply_opt.c -o ../bin/matrix_multiply_opt.out
